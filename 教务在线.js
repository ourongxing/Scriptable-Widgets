...
class Widget extends Base {
   ...
   */
  async renderSmall () {
    let res = await this.httpGet('http://jwzx.cqupt.edu.cn/data/json_files.php?pageNo=1&pageSize=20&searchKey=')
    let data = res['data']
    let topic = data[0]
    // 显示数据
  ...
  async actionOpenUrl (url) {
      Safari.openInApp("http://jwzx.cqupt.edu.cn/fileShowContent.php?id=" + url, false)
  }
